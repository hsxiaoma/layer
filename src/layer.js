...
(function () {
    ...
    // Create a safe reference to the layer object for use below.
    // 创建一个 layer 的对象引用, 保证不重复创建
    var layer = function (obj) {
        if (obj instanceof layer) return obj;
        if (!(this instanceof layer)) return new layer(obj);
    };
